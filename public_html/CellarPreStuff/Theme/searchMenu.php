...
<html lang="en">
  <head>
    ...
    <title>UPS CELLAR - Search Menu</title>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a class="avtive" href="javascript:;">
          ...
          <section class="wrapper">
            <div class="row">
              <div class="col-lg-8 main-chart">
                <form action= "searchMenuItems.php" method="post">
                <h1>Search the Cellar menu:</h1>
                <div class="wrap">
                   <div class="search">
                      <input style="width:50%;background:floralwhite;font-family:sans-serif;float:left;border:3px solid cornflowerblue;padding:5px;height:37px;border-radius:8px;outline:none;" type="Text" name="itemS" placeholder="What are you looking for?">
                      <input type="hidden" name="accountId" value="<?php echo $_GET['accountId']?>" pattern="^[0-9 ]{10}$" required>
                      <input type="hidden" name="fname" value="<?php echo $_GET['fname']?>"  >
                      <input type="hidden" name="lname" value="<?php echo $_GET['lname']?>" >
                      <button type="submit" class="searchButton" style="width:40px;height:36px;border 3px cornflowerblue;background:cornflowerblue;color:lightgrey;border-radius:5px;cursor:pointer;font-size:20px" value = "Submit" >
