...
<html lang="en">
  ...
  <section id="container" >
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  class="active" href="orderForm.php?accountId=<?php echo $_GET['accountId'] ?>&fname=<?php echo $_GET['fname'] ?>&lname=<?php echo $_GET['lname'] ?>&admin=<?php echo $_GET[admin] ?>">Place An Order</a></li>
    ...
    Type:<br>
                                ...
                                <option value="Classic Pizza">Classic Pizza</option>
                                <option value="Specialty Pizza">Specialty Pizza</option>
                                <option value="Dipping Sauces">Dipping Sauces</option>
                                <option value="Entress and Sides">Entress and Sides</option>
                                <option value="BYOP">BYOP</option>
                                <option value="Sauces">Sauces</option>
                                <option value="Cheeses">Cheeses</option>
                                <option value="Veggies">Veggies</option>
                                <option value="Meats">Meats</option>
                                <option value="Fresh Toppings">Fresh Toppings</option>
    ...
    <input type="hidden" name="itemID" value="NULL"<br>
