      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <a class="active" href="index.php?accountId=<?php echo $_GET['accountId'] ?>&fname=<?php echo $_GET['fname'] ?>&lname=<?php echo $_GET['lname'] ?>&admin=<?php echo $_GET['admin'] ?>">
      ...
      <body>
        <section id="main-content">
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-2 main-chart"></div>
                  <div class="col-lg-8 main-chart">
                    <center><h1 style="color:darkslategray;font-size:50px">Welcome to the Cellar website</h1>
                      <img src="assets/img/homepagepizza.jpg" alt="Pizza">
                      <h1 style="color:darkslategray;font-size:40px">Make an order by clicking on the link to the left, or see the menu for item details!</h1>
                      </center>
                      ...
                      <p style="font-size:20px;width:16%;float:left">Winter/summer break:
                        ...
                        <p2 style="font-size:17px;width:100%;float:left">
                          ...
                          <a href="https://www.facebook.com/UPSCellar2016/">
                            <img style="cursor:pointer"src="assets/img/facebook.webp" alt="Cellar Facebook Page" width="42" height="42" border="0">
                          </a>
                        </p2>
      </div>
      </div>
