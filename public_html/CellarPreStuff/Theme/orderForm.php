        ...
        <section id="main-content">
          <section class="wrapper">
              ...
              <div class="col-md-12">
                <form action= "placeOrder.php" method="post">
                  <ul class="list-group">
                    ...
                    <li class="list-group-item">
                      <span class="prefix">StudentID:</span>
			...
			<!-- <?php echo $tuple[itemID];?> -->
                  ...
                  <td><?php echo "<input type=\"checkbox\" name=\"order[]\" id = \"num\" value=\"$tuple[itemID]\">"; ?></td>
                </tr>
              <?php
                }
              ?>
          ...
          ?>
            <tr>
              <td><?php echo "<font size=\"3\" face = \"Ruda\" color=\"black\"> $tuple[itemName]</font>"; ?></td>
              <td><?php echo "<font size=\"3\" face = \"Ruda\" color=\"black\"> $tuple[price]</font>"; ?></td>
              <td><?php echo "<input type=\"checkbox\" name=\"order[]\" value=\"$tuple[itemID]\">"; ?></td>
            </tr>
          <?php
            }
          ?>
